    ...
    <div className="center">
      {data && (
        <div key={data.id}>
          <div className="profile">
            ...
            <div className="job">Ngày tháng năm sinh: {formattedBirthday}</div>
        ...
        <div className="Tabs">
          {datafollow.map((item) => (
            <button
              ...
              className={currentTab === `${item.id.degree.id}` ? "active" : ""}
              ...
              {currentTab === `${item.id.degree.id}` && (
                <>
                  ...
                  <div className="box">
                    ...
                    <span className="value">{item.automaticRunningHours}</span>
                  </div>
                  <div className="box">
      ...
      {showForm && (
        <div className="overlay">
          <EditInfoStudent
            selectedInfoStudent={{ ...data, birthday: new Date(data.birthday) }}
